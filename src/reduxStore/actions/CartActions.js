import { ADD_TO_CART, LOAD_LATEST_CART, REMOVE_FROM_CART, REMOVE_FROM_WISHLIST } from "../store/ACTION_DEFINATION"
...
export const LoadLatestCart = (itemArray) =>{

    return {type: LOAD_LATEST_CART, payload:itemArray}
}